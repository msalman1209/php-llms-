...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // Logo
        $this->Image('tsf.jpg', 3, 2, 60);
        $this->Image('../insert/' . $image, 18, 21.8, 30);
        $this->SetFont('Arial', '', 12);
        // Line break
        $this->Ln(44);
        $this->Cell(20, 8, 'Roll No:', 0, 0, 'L');
        $this->Cell(30, 8, "" . $_GET["id"] . "", 0, 0, 'C');
        $this->Ln();
        $this->Cell(20, 8, 'Name:', 0, 0, 'L');
        $this->Cell(30, 8, "" . $name . "", 0, 0, 'C');
        $this->Ln();
        $this->Cell(20, 8, 'Class:', 0, 0, 'L');
        $this->Cell(30, 8, "" . $class . "", 0, 0, 'C');
        $this->Ln();
        $this->Cell(20, 8, 'Group:', 0, 0, 'L');
        $this->Cell(33, 8, "" . $group . "", 0, 0, 'C');
        // $this->Image('barcode.png', 18, 90, 30);
    }
...
$pdf->AddPage();
// $code = '9B1002';
$pdf->Code128(8, 86, $rollno, 50, 10);
$pdf->SetXY(25, 96);
$pdf->Write(5, $rollno);
// foter page
// $pdf->AliasNbPages();
// $pdf->SetFont('Arial', 'B', 12);
$pdf->Output('', 'Student-Card-' . $rollno . '.pdf');