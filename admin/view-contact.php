                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select id="selectmsg" name="selectmessage" class="form-control"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        try {
                                                            ...
                                                            if ($result->rowCount() > 0) {
                                                                while ($row = $result->fetch()) { ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="phone[]"
                                        ...
                                        <div class="card-footer text-left">
                                            <input class="btn btn-dark" id="btn-submit" type="submit"
                                                value="Send Message" name="submit">
                                            <a id="btn-progress"
